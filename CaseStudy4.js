...
document.write('Berat badan ideal pria :' + '<br>' + '- untuk tinggi ', inputTinggi, ' sentimeter adalah ', beratBadanPria(inputTinggi), ' kilogram', '<br>','<br>');
document.write('Berat badan ideal wanita :' + '<br>' + '-  untuk tinggi ', inputTinggi, ' sentimeter adalah ', beratBadanWanita(inputTinggi), ' kilogram', '<br>');
